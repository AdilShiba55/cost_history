...
import com.example.costhistoryv2.ui.theme.Styles

object Inputs {
    @Composable
    fun ItemStandardInput(
        required: Boolean = false,
        title: String = "Заголовок",
        textState: MutableState<String>,
        color: Color = BoldBlue,
        changeAction: (newText: String) -> Unit = {},
        ...
        OutlinedTextField(
            ...
            label = {
                Row() {
                    ...
                    if(required) {
                        Text(text = "*", color = Color.Red, fontSize = Sizes.textMiddle)
                    }
                }
            },
            value = text,
